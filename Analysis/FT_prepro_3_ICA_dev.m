...
for s = sublist % do in separate loop because this step requires human judgement!!
    ...
    %% remove extra bad channels identified in sus pipeline & save in the prepro_2 folder
    ...
    if readyToRemove
        ...
        % save as I ...
        writeFile  = [dir_ft 'prepro_3_dev/' 'I' file_in num2str(s) '.mat'];
        save(writeFile, 'data');  
        clear data
        clear comp
    end
